package com.miles.music.core.io.net.client;

import com.miles.music.core.constant.RateLimiterConstants;
import com.miles.music.core.exception.RateLimitException;
import com.miles.music.core.third.lastfm.LastfmClient;
import com.miles.music.core.third.lastfm.model.Artist;
import com.miles.music.core.third.lastfm.model.ArtistInfo;
import com.miles.music.core.third.lastfm.model.Track;
...
public class LastfmApiDataFetchClient implements MetaDataFetchApiClient {
    ...
    @Nullable
    @Override
    public com.miles.music.core.io.net.model.ArtistInfo fetchArtistInfo(String artistName) {
        ...
        com.miles.music.core.io.net.model.ArtistInfo result = new com.miles.music.core.io.net.model.ArtistInfo();
