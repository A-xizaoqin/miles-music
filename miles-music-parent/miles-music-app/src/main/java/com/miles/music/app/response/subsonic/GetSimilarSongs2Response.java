package com.miles.music.app.response.subsonic;

import com.alibaba.fastjson2.annotation.JSONField;
import com.fasterxml.jackson.annotation.JsonFormat;
import com.fasterxml.jackson.dataformat.xml.annotation.JacksonXmlElementWrapper;
import com.fasterxml.jackson.dataformat.xml.annotation.JacksonXmlProperty;
import com.miles.music.core.util.DateTimeUtils;
import lombok.*;
...
@AllArgsConstructor
@NoArgsConstructor
public class GetSimilarSongs2Response extends SubsonicResponse{
    ...
    public static class SimilarSongs {
        ...
        @JSONField(name = "song")
        private List<GetSimilarSongs2Response.Song> songs;
    }
