 ...
 **/
@SpringBootApplication(scanBasePackages = "com.miles.music")
@EnableScheduling
@EnableTransactionManagement
public class MilesMusicApplication  {
    ...
    public static void main(String[] args) {
        ...
        SpringApplication.run(MilesMusicApplication.class, args);
    }
}